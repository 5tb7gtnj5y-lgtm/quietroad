    ...
    <div className="main-grid">
      ...
      <div className="results" aria-live="polite">
        ...
        {plan && <>
          ...
          <footer className="result-sources">Traffic patterns: <a href="https://www.gov.uk/government/statistical-data-sets/road-traffic-estimates-tra#annual-daily-traffic-flow-and-distribution-tra03" target="_blank" rel="noreferrer">Department for Transport (including table TRA0307)</a>. Routing and Greggs: <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noreferrer">© OpenStreetMap contributors</a> via OSRM / Photon / Overpass. {plan.liveStatus === 'available' ? 'Live speed: TomTom. ' : ''}<a href="https://nationalhighways.co.uk/roads-and-travel/live-travel-updates/" target="_blank" rel="noreferrer">Check current incidents with National Highways</a>.</footer>
        </>}
      </div>
    </div>
  </main>;
