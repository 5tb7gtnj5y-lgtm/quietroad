...
export async function POST(req: NextRequest) {
  try {
    ...
    const plan: Plan = {
      ...
      requestedDate: date, profileSource: profile.profileSource, greggs, greggsStatus: !includeGreggs ? 'not-requested' : bakeries.status === 'fulfilled' ? 'available' : 'unavailable',
